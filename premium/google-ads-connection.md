...
Click **Connections** in the sidebar (under the **Platforms** section). This page shows all available platform connections.

![Connections page](../images/google-ads-integrations-page.png)
...
Once connected, the Connections page updates to show your connected account(s) with their details.
...
For each connected account, the Connections page displays:
...
- A warning banner appears on the Connections or Sync page
...
**Solution:**
- Go to the Connections page and click **Reconnect** on the affected account
...
**Related:**
- [Connections](integrations.md) — Manage all platform connections
